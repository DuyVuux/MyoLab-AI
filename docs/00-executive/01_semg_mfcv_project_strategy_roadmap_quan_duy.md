...
- Duy giữ 60–65% core technical/AI/product architecture. Quân giữ 35–40% core technical/product, đồng thời lead execution, dashboard, QA, report, workflow và operational readiness.
...
Duy được thiên vị làm core hơn: lead technical architecture, signal pipeline, QC/abstention, preprocessing, feature extraction, FRS, inference/rule engine, use case routing, clinical interpretation, output schema, decision gates và technical go/no-go. Quân vẫn làm core quan trọng: signal ingestion, feature extraction support, QC test cases, API contract, dashboard integration, report generation, validation automation, security/audit baseline. Quân đồng thời lead execution rhythm, sprint board, UX/demo, QA, documentation và stakeholder-ready deliverables.

Cách thiên vị Duy mà không tạo single point of failure: mọi module core có reviewer chéo; Quân nhận phần core đủ sâu ở ingestion/API/QC tests/feature validation/report/data contract; Duy phải viết specs rõ để Quân có thể triển khai và thay thế khi cần.
...
- Duy lead quyết định core nhất: architecture, signal/QC/preprocessing/feature/FRS/inference, clinical logic, output schema, decision gates.
...
- Quân không được chỉ làm docs/demo: ít nhất 35% task của Quân trong 30 ngày là core technical/product như importer, API, QC tests, feature outputs, report schema, validation tests.
