"""Deterministic UC2 metric functions for Day 23 quantitative assessment."""
...
class MetricNotComputable(ValueError):
    """Raised when a metric cannot be computed with the provided inputs."""
...
def co_contraction_index_percent(
    agonist: float,
    antagonist: float,
    *,
    epsilon: float = 1e-9,
