...
def main():
    required = ['FR-036', 'FR-037', 'PRD_PRESERVE_PHYSIOLOGY']
    impact = yaml.safe_load((ROOT / 'qa-validation/traceability/day28-requirement-impact.yaml').read_text())
    ...
    print('DAY28 contract validator: PASS')
