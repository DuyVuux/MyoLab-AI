#!/usr/bin/env python3
"""Day 32 — End-to-end tooling smoke validation.

Runs synthetic data through the full Day 32 pipeline:
model factory → grouped folds → core smoke → core gate.
Writes structured evidence to qa-validation/evidence/day32/.
"""
...
data = np.load(
    ROOT / "qa-validation" / "fixtures" / "day32-synthetic-matrix.npz",
    allow_pickle=False,
)
...
out = ROOT / "qa-validation" / "evidence" / "day32" / "day32-tooling-validation.json"
