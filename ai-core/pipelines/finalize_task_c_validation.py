...
def main():
    ...
    prerequisite_status_accepted = input_gate.get("task_c_prerequisite_status_accepted", input_gate.get("day36_status_accepted"))
    if not prerequisite_status_accepted or input_gate.get("hard_fatigue_diagnosis_allowed"):
        print("Task C input gate failed. Blocking validation finalization.")
        status = "BLOCKED_WITH_EVIDENCE"
    else:
        status = "GO_FOR_TASK_C_VALIDATION"
